          ...
          {GAME_LIST.map((game) => {
            ...
            return (
              <button
                ...
                className={`relative group flex items-center gap-2.5 px-3.5 py-2 rounded-xl text-xs font-medium transition-all duration-200 whitespace-nowrap cursor-pointer select-none ${
                  isActive
              ...
              >
                ...
                <div className="flex flex-col text-left">
                  ...
                  <span className={`text-[10px] font-mono leading-none mt-0.5 ${isActive ? "text-aurora-cyan/80 font-bold" : "text-aurora-text-muted/60"}`}>
